    ...
    return (
        <footer className="footer">
            <div className="column wider">
                ...
                <p>Nuestra compañía se dedica a desarrollar soluciones tecnológicas avanzadas que permiten optimizar y agilizar los procesos relacionados con la industria metalúrgica.</p>
            ...
            <div className="column wider">
                ...
                <div className='svg-footer'>
                    ...
                    <a href="https://www.facebook.com/Misiratech"
                        target="_blank"
                        rel="noopener noreferrer">
                        <svg className='svg-icon' width="45" height="45" viewBox="0 0 108 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://www.youtube.com/@Misiratech"
                        target="_blank"
                        rel="noopener noreferrer">
                        <svg className='svg-icon' width="45" height="45" viewBox="0 -3 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <a href="https://www.instagram.com/misiraoficial/"
                        target="_blank"
                        rel="noopener noreferrer">
                        <svg className='svg-icon' width="45" height="45" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
